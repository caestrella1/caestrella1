...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex size-10 items-center justify-center rounded-full bg-neutral-100 text-neutral-600 transition-smooth duration-300 hover:bg-neutral-200 hover:text-neutral-900 dark:bg-neutral-800/80 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white"
    >
